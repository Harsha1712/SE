...
const onFormSubmit=(userObj)=>{
    ...
    return (
        ...
        <Form.Group className='mb-3'>
                ...
                <Form.Control type='text' placeholder="Enter Acc No." {...register("accno",{required:true})}/>
                {errors.accno&&<p classname='text-danger'>*Account number is required</p>}
            </Form.Group>
            <Form.Group className='mb-3'>
                <Form.Label>
                    Username
            ...
            <Form.Group className='mb-3'>
                ...
                <Form.Control type='number' placeholder="Enter Amount" {...register("balance",{required:true})}/>
                {errors.balance&&<p classname='text-danger'>*Balance should not be 0</p>}
            </Form.Group>
            <Form.Group className='mb-3'>
                <Form.Label>
                    Select File
